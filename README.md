...
- **[Pictify](https://github.com/pictify-io/mcp)** - Generate images, GIFs, and PDFs from HTML/CSS, URLs, or reusable Handlebars/FabricJS templates. Batch up to 100 personalised renders per request and A/B test image variants. Hosted remote at `https://mcp.pictify.io` or `npx @pictify/mcp-server`.
